...
class DrawTexModel(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(200, 400, 9, bias=False)  # 37x37 -> 29x29
        self.conv2_bn = nn.BatchNorm2d(400)
        self.conv3 = nn.Conv2d(400, 800, 9, bias=False)  # 29x29 -> 21x21
        self.conv3_bn = nn.BatchNorm2d(800)
        self.conv4 = nn.Conv2d(800, 1200, 9, bias=False)  # 21x21 -> 13x13
        self.conv4_bn = nn.BatchNorm2d(1200)
        self.conv5 = nn.Conv2d(1200, 1800, 9, bias=False)  # 13x13 -> 5x5
        self.conv5_bn = nn.BatchNorm2d(1800)
        self.lin1 = nn.Linear(45000, 82, bias=False)
